            ...
            <div className="frame-2">
              <div className="frame-3">
                <div className="frame-4">
                  <div className="request-for-visit">Create Account</div>
                  <img
                  ...
                  <div className="labels">
                    ...
                    <div className="text-field-large">
                      <div className="frame-5">
                        ...
                        <input type="text" ref={email} className="Input" placeholder="enter your email" />
                      </div>
                    </div>
                    <div className="text-field-large">
                      <div className="frame-5">
              ...
              <div className="check-wrapper">
                <div className="check">
                  ...
                  <p className="i-agree-to-all-terms">I agree to all Terms &amp; Conditions</p>
                </div>
              </div>
            </div>
            <div className="button-style-small-wrapper" onClick={handleRegister}>
              <div className="button-style-small">
                <div className="send-request">Create Account</div>
              </div>
            </div>
            <img className="line" alt="Line" src="https://c.animaapp.com/WW0sOHBk/img/line-3.svg" />
            <div className="frame-6">
              <div className="don-t-have-an">Have an account?</div>
              <Link to={"/user/login"} className="text-wrapper">Log in</Link>
            </div>
          </div>
        </div>
      </div>
